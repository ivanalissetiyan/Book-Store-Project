        ...
        <div class="col-md-6">
            ...
            <div class="card border-0 shadow-sm rounded mt-80">
                <div class="card-body p-5">
                    ...
                    <form wire:submit.prevent="register">
                        ...
                        <button class="btn btn-blue-2 w-100 rounded" type="submit">Register</button>
                    </form>
                </div>
            </div>
            ...
            <div class="mt-4">
                <div class="text-center">
                    ...
                    <a href="/login" class="text-decoration-none fw-bold text-blue ms-2" wire:navigate>Login</a>
                </div>
            </div>
